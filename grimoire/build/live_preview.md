...
7. Patch files by exact string or by line markers that are plain ASCII; typographic dashes in comments break string matching across tools. When a patch script fails, nothing was written — do not trust the next render.
